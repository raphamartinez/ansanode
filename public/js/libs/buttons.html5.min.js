...
(g=e.messageTop+f+f+g);e.messageBottom&&(g=g+f+f+e.messageBottom);b.customize&&(g=b.customize(g,b,c));b=n("<textarea readonly/>").val(g).appendTo(d);if(x.queryCommandSupported("copy")){d.appendTo(c.table().container());b[0].focus();b[0].select();try{var p=x.execCommand("copy");d.remove();if(p){c.buttons.info(c.i18n("buttons.copyTitle","Copiado para \u00e1rea de transfer\u00eancia"),c.i18n("buttons.copySuccess",{1:"Copiado 1 linha para a \u00e1rea de transfer\u00eancia",_:"Copiado %d linhas para a \u00e1rea de transfer\u00eancia"},a.rows),2E3);this.processing(!1);return}}catch(q){}}p=
n("<span>"+c.i18n("buttons.copyKeys","Pressione <i>ctrl</i> ou <i>⌘</i> + <i>C</i> para copiar os dados da tabela<br>para sua \u00e1rea de transfer\u00eancia.<br><br>Para cancelar, clique nesta mensagem ou pressione escape.")+"</span>").append(d);c.buttons.info(c.i18n("buttons.copyTitle","Copiado para \u00e1rea de transfer\u00eancia"),p,0);b[0].focus();b[0].select();var t=n(p).closest(".dt-button-info"),h=function(){t.off("click.buttons-copy");n(x).off(".buttons-copy");c.buttons.info(!1)};t.on("click.buttons-copy",h);n(x).on("keydown.buttons-copy",function(q){27===
