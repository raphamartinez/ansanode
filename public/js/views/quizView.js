            ...
            <div class="form-row">
                ...
                <div class="col-lg-3 d-inline text-center">
                    <div class="row-fluid mb-2" row-name-one>
                        ...
                        <div class="col-md-12">
                            <select title="Nombres" data-names-one id="nameone" class="form-select selectpicker">
                            </select>
                        </div>
                    </div>
                    <hr>
            ...
            <div class="form-row" data-div-quiz-two-graph>
                ...
                <div class="col-lg-3 d-inline text-center">
                    <div class="row-fluid mb-2">
                        <div class="col-md-12">
                            <h5>Nombre del Repondente</h5>
                            <select title="Nombres" id="nametwo" data-names-two class="form-select selectpicker">
                            </select>
                        </div>
                    </div>
                    <hr>
